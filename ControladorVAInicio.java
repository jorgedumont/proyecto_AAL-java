...
public class ControladorVAInicio extends ControladorFicheros {

	private static final String FICHERO = "./data/usuarios2.txt";
	@FXML
	...
	@FXML
	private TextField TxtFNickname2;
	...
	public int UsuariosHombre() throws IOException {
		return contar_sexo(FICHERO, "hombre");
	}

	public int UsuariosMujeres() throws IOException {
		return contar_sexo(FICHERO, "mujer");
	}

	public void ActualizarTotales() {

		try {
			this.TxtFNickname.setText("" + contar_numero_lineas_fichero(FICHERO));
			this.TxtFNickname1.setText("" + this.UsuariosHombre());
			this.TxtFNickname2.setText("" + this.UsuariosMujeres());
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	@FXML
	public void Logout(ActionEvent cerrarVentana) {// queremos cerrar la ventana
													// de usuario y abrir la de
													// login
